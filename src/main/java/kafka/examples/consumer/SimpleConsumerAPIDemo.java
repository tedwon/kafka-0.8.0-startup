...
public class SimpleConsumerAPIDemo {

  public static void main(String args[]) {
    SimpleConsumerAPIDemo example = new SimpleConsumerAPIDemo();
  ...
  public void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers,
    ...
    long
        readOffset =
        getLastOffset(consumer, a_topic, a_partition, kafka.api.OffsetRequest.EarliestTime(),
                      clientName);
    ...
    while (a_maxReads > 0) {
      ...
      if (fetchResponse.hasError()) {
        ...
        if (code == ErrorMapping.OffsetOutOfRangeCode()) {
          ...
          readOffset =
              getLastOffset(consumer, a_topic, a_partition, kafka.api.OffsetRequest.LatestTime(),
                            clientName);
          continue;
        }
        consumer.close();
